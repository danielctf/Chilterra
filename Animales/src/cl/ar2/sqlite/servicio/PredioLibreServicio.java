...
public class PredioLibreServicio {
    ...
    public static void deletePLBrucelosisLog(Integer ganadoId) throws AppException {
        SqLiteTrx trx;
        ...
        if (trx != null) {
            try {
                PredioLibreDAO.deletePLBrucelosisLog(trx, ganadoId);
                trx.commit();
            } catch ( SQLException ex ) {
                trx.rollback();
                throw new AppException(ex.getMessage(), null);
    ...
    public static void deletePLBrucelosisLogLecturaTB(Integer ganadoId) throws AppException {
        SqLiteTrx trx;
        ...
        if (trx != null) {
            try {
                PredioLibreDAO.deletePLBrucelosisLogLecturaTB(trx, ganadoId);
                trx.commit();
            } catch ( SQLException ex ) {
                trx.rollback();
                throw new AppException(ex.getMessage(), null);
    ...
    public static void updateGanFundo(Integer nuevoFundoId, Integer ganadoId) throws AppException {
        SqLiteTrx trx;
        ...
        if (trx != null) {
            try {
                PredioLibreDAO.updateGanFundo(trx, nuevoFundoId, ganadoId);
                trx.commit();
            } catch ( SQLException ex ) {
                trx.rollback();
                throw new AppException(ex.getMessage(), null);
