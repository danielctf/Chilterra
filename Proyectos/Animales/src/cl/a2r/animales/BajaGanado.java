...
public class BajaGanado extends Activity {
	...
	private TextView despliegaDiio;
	private Spinner motivoBaja;
	...
	private void cargarInterfaz(){
		...
		motivoBaja = (Spinner)findViewById(R.id.motivoBaja);
		
	}
	
	private void getMotivosBajaWS(){
		String[] motivos = {"Muerte", "Sacrificio", "Venta"};
		ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, motivos);
		//mAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		motivoBaja.setAdapter(mAdapter);
	}
