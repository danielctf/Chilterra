...
public class Relajacion extends Activity implements OnSeekBarChangeListener, OnCompletionListener{
	...
	protected void onCreate(Bundle savedInstanceState){
        ...
        if(width==240 && height==320){
        	setContentView(R.layout.relajacion240x320);
        }else{
        	if(width==320 && height==480){
        		setContentView(R.layout.relajacion320x480);
        	}else{
        		if(width==480 && height==800){
        			setContentView(R.layout.relajacion480x800);
        		}else{
        			if(width==480 && height==854){
        				setContentView(R.layout.relajacion480x854);
        			}else{
        				if(width==720 && height==1280){
        					setContentView(R.layout.relajacion720x1280);
        				}
        				if(width==720 && height >1100 && height<1280){
        					setContentView(R.layout.relajacion720x1280);
        				}else{
        					if(width==800 && height==1280){
        						setContentView(R.layout.relajacion800x1280);
        					}
