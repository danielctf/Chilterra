...
public class Logs extends Activity implements View.OnClickListener{
	...
	private List<String> diios;
	private List<RegistroMedicion> deletedLogId;
	public static int sr_ganado, diio;
	private List<RegistroMedicion> list;
	...
	private void cargarInterfaz(){
		...
		deletedLogId = new ArrayList<RegistroMedicion>();
    ...
    private void animateRemoval(final ListView listview, View viewToRemove) {
        ...
        for (int i = 0; i < list.size(); i++){
        	if (list.get(i).getMedicion().toString().equals((mAdapter.getItem(position)))){
        		deletedLogId.add(list.get(i));
        	}
        }
